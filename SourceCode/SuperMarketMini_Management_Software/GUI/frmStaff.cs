    ...
    public partial class frmStaff : Form
    {
        ...
        public void CreateNewStaffID()
        {
            ...
            if(index != 0)
            {
                ...
                a = string.Format("{0:00}", Id + 1); //cộng thêm 1 cho số 1 => id mới = 2, format 2 thành "02"
            }
        ...
        public string createUsername(string Name, string PhoneNumber, string day, string month)
        {
            ...
            username4 = username4.Length > 15 ? username4.Substring(username4.Length - 15) : username4;
            return username4;
        }
