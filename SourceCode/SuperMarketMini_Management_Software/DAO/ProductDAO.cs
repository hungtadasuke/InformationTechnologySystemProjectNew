...
namespace DAO
{
    public class ProductDAO
    {
        ...
        {
            string querryProductSearchList = $"select C.CategoryName, P.ProductId,  P.ProductName, P.Unit, P.ImportPrice, P.PriceToSell, P.Quantity, P.ProductImg, P.StatusItem, P.BarCode from Product as P, Category as C where P.CategoryId = C.CategoryId";
