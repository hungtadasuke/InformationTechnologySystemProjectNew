create database SuperMarket_Management_DB_Version3;

go

use SuperMarket_Management_DB_Version3;
...
create procedure insertProduct @ProductImg image, @ProductName nvarchar(100), @ImportPrice money, @PriceToSell money, @Unit nvarchar(20), @Quantity int, @StatusItem bit, @CategoryId varchar(4), @BarCode varchar(13)
as
begin
	if(@BarCode = 'null')
...
create procedure updateProduct @ProductImg image, @ProductName nvarchar(100), @ImportPrice money, @PriceToSell money, @Unit nvarchar(20), @Quantity int, @StatusItem bit, @CategoryId varchar(4), @ProductId varchar(6), @BarCode varchar(13)
as
begin
	if(@BarCode = 'null')
...
delete from product where id = 48;
